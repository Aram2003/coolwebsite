...
<html>
    ...
    <body class = "big-box" style="background-image:url('../../images/admin.jpg')">
           <article>
            <div class="container">
                <h1 style = "color:white">Admin Games</h1>
                <hr>
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                    	<h2 style = "color:white">All Games</h2>
                      <a href='create.php' id="create" class='btn btn-primary btn-xm' role="button">New Game </a>
                      <table class="table" id="myTable">
                                ...
                                <?php $sql = "SELECT * FROM games";
                                     ...
                                     $gm = mysqli_fetch_all($res,MYSQLI_ASSOC);
                                     foreach($gm as $p)
                                     {
                                        echo "<tr>";
                                        echo "<td>".$p["id"]."</td>";
