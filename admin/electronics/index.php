            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                    	<h2 style = "color:white">All  Electroncs</h2>
                      <a href='create.php' id="create" class='btn btn-primary btn-xm' role="button">New Electronic </a>
                      <table class="table" id="myTable">
                                ...
                                <tbody>
                                <?php $sql = "SELECT * FROM electronics";
                                     $res = mysqli_query($kap,$sql); 
                                     $el = mysqli_fetch_all($res,MYSQLI_ASSOC);
                                     foreach($el as $p)
                                     {
                                        echo "<tr>";
                                        echo "<td>".$p["id"]."</td>";
